...
const ProductCard = ({ product }) => {
    ...
    return (
        <div
            ...
            className="relative m-3 w-[220px] h-72 flex flex-col justify-start items-center rounded-md overflow-hidden cursor-pointer"
        >
            <div className="relative p-8 w-full h-[230px] flex justify-center items-center border border-gray-200 rounded-md overflow-hidden">
                <a href={'to Product page'} className="h-[200px] overflow-clip">
                    <img
                        src={product.image}
                        alt={product.title}
            ...
            <a href={'to Product page'} className="px-3 w-full">
